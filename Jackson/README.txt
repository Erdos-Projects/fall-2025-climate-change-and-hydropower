All data can be found either per state, state division, or county (county is not as expansive and there are missing counties)
-Monthly Percipitation
-Monthly Average Temperature 
-Monthly Low Temperature
-Monthly High Temperature

Statewide/Regional/US
-Drought/Wet Spell based on the Palmer Drought Severity Index
